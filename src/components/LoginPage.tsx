...
function Frame5() {
  return (
    <div className="content-stretch flex flex-col gap-[41px] items-end leading-[30px] not-italic relative shrink-0 text-[#e0e0e0] w-[445px]">
      <p className="font-['Poppins:Semi_Bold',sans-serif] font-semibold relative shrink-0 text-[25px] text-center w-full">
        Your courage inspires us—Every step forward is a step toward healing and
        hope.
      </p>
      <p className="font-['Poppins:Regular',sans-serif] font-normal relative shrink-0 text-[18px] text-right w-full">
        ~ Safe AI Team
      </p>
    </div>
  );
  ...
  return (
    <div className="content-stretch flex flex-col gap-[18px] items-start not-italic relative shrink-0 w-full pl-[150px]">
      ...
      <p className="font-['Poppins:Regular',sans-serif] font-normal leading-[25px] relative shrink-0 text-[#b0b0b0] text-[14px] w-[419px]">
        Please fill in the information below to log back into your account
      </p>
    </div>
  );
}
    ...
    >
      ...
      >
        <g clipPath="url(#clip0_1_51)" id="eye">
          <path
            d={svgPaths.p3d74ed00}
            id="Vector"
            stroke="var(--stroke-0, #B0B0B0)"
            strokeLinecap="round"
  ...
  return (
    ...
    >
      ...
      <form
        ...
        className="absolute content-stretch flex flex-col gap-[33px] items-start left-[50px] top-[151px] w-[483px]"
      >
        <Frame8 />
        <Frame4 />
